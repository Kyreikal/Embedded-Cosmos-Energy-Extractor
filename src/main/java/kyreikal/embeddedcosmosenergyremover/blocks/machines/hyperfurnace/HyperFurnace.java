...
public class HyperFurnace extends BlockBase implements ITileEntityProvider 
{
	public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public static final PropertyBool BURNING = PropertyBool.create("burning");
	
	public HyperFurnace(String name) 
	{
	...
	{
		return Item.getItemFromBlock(ModBlocks.HYPER_FURNACE);
	}
	
	@Override
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
	{
		return new ItemStack(ModBlocks.HYPER_FURNACE);
	}
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) 
	{
		if(!worldIn.isRemote)
		{
			playerIn.openGui(Main.instance, Reference.GUI_HYPER_FURNACE, worldIn, pos.getX(), pos.getY(), pos.getZ());
		}
	...
	public static void setState(boolean active, World worldIn, BlockPos pos)
	{
		...
		if(active) worldIn.setBlockState(pos, ModBlocks.HYPER_FURNACE.getDefaultState().withProperty(FACING, 
				state.getValue(FACING)).withProperty(BURNING, true), 3);
		else worldIn.setBlockState(pos, ModBlocks.HYPER_FURNACE.getDefaultState().withProperty(FACING, 
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) 
	{
		...
		return new TileEntityHyperFurnace();
	}
	...
	{
	    TileEntityHyperFurnace tileentity = (TileEntityHyperFurnace)worldIn.getTileEntity(pos);
