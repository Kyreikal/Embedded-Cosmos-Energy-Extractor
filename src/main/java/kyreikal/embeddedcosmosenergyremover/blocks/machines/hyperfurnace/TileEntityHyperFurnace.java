...
public class TileEntityHyperFurnace extends TileEntity implements IInventory, ITickable
{
    ...
    public void update() 
    {
        ...
        if(!this.world.isRemote) 
        {
            ...
            {
                flag1 = true;
                HyperFurnace.setState(this.isBurning(), this.world, this.pos);
            }
        } 
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack result = HyperFurnaceRecipes.getInstance().getHyperResult((ItemStack)this.inventory.get(0), this.inventory.get(1), false);
    ...
    public void smeltItem() 
    {
        if(this.canSmelt()) 
        {
            ...
            ItemStack result = HyperFurnaceRecipes.getInstance().getHyperResult(input1, input2, false);
            ItemStack output = (ItemStack)this.inventory.get(3);
